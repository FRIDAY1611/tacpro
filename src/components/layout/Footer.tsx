...
export function Footer({ locale, messages, navMessages }: FooterProps) {
  const currentYear = new Date().getFullYear()

  const quickLinks = [
    { href: '/', label: navMessages.home },
    { href: '/products', label: navMessages.products },
    { href: '/cases', label: navMessages.cases },
    { href: '/blog', label: navMessages.blog },
    { href: '/about', label: navMessages.about },
    { href: '/contact', label: navMessages.contact },
  ]
    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-white font-semibold mb-4">{messages.quickLinks}</h3>
          ...
          {/* Products */}
          <div>
            <h3 className="text-white font-semibold mb-4">{messages.products}</h3>
            <ul className="space-y-3">
